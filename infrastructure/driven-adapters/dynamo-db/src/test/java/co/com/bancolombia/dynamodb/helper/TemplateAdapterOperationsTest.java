...
import co.com.bancolombia.dynamodb.LoanApprovalReportEntity;
...
class TemplateAdapterOperationsTest {
    ...
    @Mock
    private DynamoDbAsyncTable<LoanApprovalReportEntity> customerTable;

    private LoanApprovalReportEntity modelEntity;
    ...
    void setUp() {
        ...
        modelEntity = new LoanApprovalReportEntity();
        modelEntity.setReportName("id");
        modelEntity.setTotalApprovedLoans(1l);
    }
